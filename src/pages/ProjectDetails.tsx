...
const ProjectDetails = () => {
  ...
  const galleryImages = [
    ...
    "https://images.unsplash.com/photo-1600607687939-ce8a6c349279?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80",
  ...
  return (
    <>
      ...
      <main>
        {/* Hero Image Section */}
        <div className="relative h-[60vh] md:h-[80vh] bg-estate-beige overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 p-6 md:p-12">
            <div className="container mx-auto">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-2">{project.title}</h1>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-lg text-estate-charcoal/80 mb-8">{project.description}</p>
